App = {
    ...
    renderRecentTransactions: async () => {
        ...
        for (var i = totalRegistered.toNumber(); i >= 1; i--) {
            ...
            let created_at = await townShip[7];
            ...
            let townShipItem =
                ...
                <div class="card mt-4">
                    <div class="card-body">
                        <h4 class="card-title"><strong><i class="fa fa-calendar text-muted" aria-hidden="true"></i> ` + created_at + `</strong></h4>
    ...
    registerLand: async (data) => {
        ...
        await App.landRegistry.registerTownShip(Number(townshipId), Number(owner_nid), owner_name, owner_address, owner_father_name, owner_mother_name,now);
